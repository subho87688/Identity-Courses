...
public class ExtentReportManager implements ITestListener
{
	...
	public void onStart(ITestContext testContext) {
		...
		sparkReporter.config().setDocumentTitle("Hackthon Automation Report"); 		// Title of report
		sparkReporter.config().setReportName("Coursera Websites Testing"); 	// name of the report
		...
		extent.setSystemInfo("Application", "Coursera Website");
		extent.setSystemInfo("Module 1", "Course Extraction");
		extent.setSystemInfo("Module 2", "Language and Levels Extraction");
		extent.setSystemInfo("Module 3", "Form Validation");
